    ...
    public partial class LMSContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Assignment>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Name, e.CategId }, "assignments_info")
                    .IsUnique();

                entity.HasIndex(e => e.CategId, "categID");
            ...
            modelBuilder.Entity<AssignmentCategory>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Name, e.ClassId }, "assignment_categories_info")
                    .IsUnique();
            ...
            modelBuilder.Entity<Class>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Year, e.Season, e.CId }, "class_info")
                    .IsUnique();
            ...
            modelBuilder.Entity<Course>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.CNum, e.Subject }, "course_info")
                    .IsUnique();
